...
/**
 device timezon -12.00 to 12.00. Without setting, default timezone is 0.00
 */
@property (assign, nonatomic, readonly) float deviceTimeZone;

/**
 quantity of strip used in measurement
 */
@property (assign, nonatomic, readonly) NSInteger stripUsedValue;

/**
 quantity of record measuring without connecting to APP
 */
...
/**
 measure unit (BGUnit_mmolPL stands for mmol/L,BGUnit_mgPmL stands for mg/dL)
 */
